    ...
    <div className="bg-gray-900 min-h-screen">
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-10 p-6 bg-gray-800 rounded-xl shadow-soft">
            ...
            <div className="grid grid-cols-1 gap-4 text-left">
              <div>
                ...
                <p className="font-medium text-white">{bookingDetails.confirmationNumber}</p>
              </div>
              
              <div>
                <p className="text-sm text-gray-400">Service</p>
                <p className="font-medium text-white">{bookingDetails.service}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium text-white">{bookingDetails.time}</p>
              </div>
            </div>
          </div>
