      ...
      <div className="relative bg-gradient-to-b from-gray-800/70 to-gray-900/70">
              ...
              <div className="mt-8 text-center">
                <div className="mb-4">
                  <Image 
                    ...
                    width={192}
                    height={192}
                    className="h-48 w-48 rounded-full object-cover mx-auto border-4 border-primary-800 shadow-glow"
                  />
                </div>
                <h2 className="text-2xl font-semibold text-primary-400">Acharya Abbhiraath Singh</h2>
                <p className="text-lg text-primary-500">(Nadi Vaidya)</p>
                <p className="mt-2 text-gray-300">Health & Wellness Coach | Spiritual Coach</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8">
          ...
          <div className="mx-auto max-w-3xl card p-8 hover:shadow-glow transition-all duration-300 page-section">
            <h2 className="text-2xl font-bold tracking-tight text-primary-400">Namaste and Welcome</h2>
          ...
          <div className="mx-auto mt-16 max-w-3xl page-section">
            <div className="flex items-center mb-6">
              <div className="h-1 flex-1 bg-gradient-to-r from-transparent to-primary-500/30"></div>
              <h2 className="text-2xl font-bold tracking-tight text-white px-4">My Background</h2>
              <div className="h-1 flex-1 bg-gradient-to-l from-transparent to-primary-500/30"></div>
            </div>
            ...
            <ul className="mt-6 space-y-4">
              {[
                ...
                <li key={index} className="flex items-start group">
                  <span className="flex-shrink-0 h-6 w-6 rounded-full bg-primary-900/30 text-primary-400 flex items-center justify-center mr-3 mt-1 group-hover:bg-primary-800/30 transition-colors">
                    <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                  </span>
                  <span className="text-lg leading-7 text-white">{item}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="mx-auto mt-16 max-w-3xl page-section">
            <div className="flex items-center mb-6">
              <div className="h-1 flex-1 bg-gradient-to-r from-transparent to-primary-500/30"></div>
              <h2 className="text-2xl font-bold tracking-tight text-white px-4">What I Offer</h2>
              <div className="h-1 flex-1 bg-gradient-to-l from-transparent to-primary-500/30"></div>
            </div>
                ...
                <ul className="mt-4 space-y-2">
                  {[
                    ...
                    <li key={index} className="flex items-start">
                      <span className="flex-shrink-0 h-5 w-5 rounded-full bg-primary-900/30 text-primary-400 flex items-center justify-center mr-2 mt-0.5">
          ...
          <div className="mx-auto mt-16 max-w-3xl page-section">
            <div className="flex items-center mb-6">
              <div className="h-1 flex-1 bg-gradient-to-r from-transparent to-primary-500/30"></div>
              <h2 className="text-2xl font-bold tracking-tight text-white px-4">My Philosophy</h2>
              <div className="h-1 flex-1 bg-gradient-to-l from-transparent to-primary-500/30"></div>
            </div>
            
            <div className="card p-8 bg-gradient-to-br from-gray-800 to-gray-900 shadow-soft">
              ...
              <p className="text-lg leading-8 text-gray-300 italic text-center">
          ...
          <div className="mx-auto mt-16 max-w-3xl page-section">
            <div className="flex items-center mb-6">
              <div className="h-1 flex-1 bg-gradient-to-r from-transparent to-primary-500/30"></div>
              <h2 className="text-2xl font-bold tracking-tight text-white px-4">Our Values</h2>
              <div className="h-1 flex-1 bg-gradient-to-l from-transparent to-primary-500/30"></div>
            </div>
            ...
            <dl className="mt-10 grid grid-cols-1 gap-8 sm:grid-cols-2">
              {values.map((value, index) => (
                ...
                >
                  ...
                  <dd className="mt-4 text-base text-gray-300">{value.description}</dd>
                </div>
              ))}
            </dl>
          </div>
